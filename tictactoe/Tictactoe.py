...
# --- JavaScript Refresh ---
# This snippet forces a full page reload every 1 second to update the timer.
refresh_script = """
<script>
...
# A helper function to safely trigger a rerun.
def safe_rerun():
    try:
        st.experimental_rerun()
    except AttributeError:
        # If experimental_rerun isn't available, rely on the JS auto-refresh.
        pass
